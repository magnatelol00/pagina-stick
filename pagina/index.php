    ...
    <header class="header">
        ...
        <div class="header-content container">
            <div class="header-txt">
                <h1>Compra tu Licor <samp>  </samp> <br> favorito aca </h1>
                <p>
                    En nuestra licorera, cada botella cuenta una historia.
                    Descubre una selección exclusiva de licores para celebrar,
                    compartir y disfrutar los mejores momentos. ¡Brindemos juntos
